...
void MainMenuView::setupScreen()
{
    ...
    backgroundRight.setXY(container.getWidth() - backgroundRight.getWidth(), 0);
    add(backgroundRight);
    ...
    menuContainer.setDotIndicatorXYWithCenteredX(container.getWidth() / 2, container.getHeight() - 16);
