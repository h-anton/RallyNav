...
EasingEquationInOutSelectorGroup::EasingEquationInOutSelectorGroup() :
    onSelected(this, &EasingEquationInOutSelectorGroup::selected),
...
void EasingEquationInOutSelectorGroup::setInOrOutSelectedCallback(GenericCallback<EasingEquationsInOrOut>& callback)
{
    inOrOutSelectedCallback = &callback;
}

void EasingEquationInOutSelectorGroup::selected(const AbstractButton& btn)
{
...
void EasingEquationInOutSelectorGroup::selectFirst()
{
    buttons.setSelected(in.getRadioButton());
}

void EasingEquationInOutSelectorGroup::setButtonColors()
{
    int selected = buttons.getSelectedRadioButtonIndex();

    in.setTextColor(Color::getColorFromRGB(0x9D, 0xC9, 0xD1), 0);
    out.setTextColor(Color::getColorFromRGB(0x9D, 0xC9, 0xD1), 0);
    inOut.setTextColor(Color::getColorFromRGB(0x9D, 0xC9, 0xD1), 0);

    switch (selected)
    {
    case 0:
        in.setTextColor(Color::getColorFromRGB(0xFF, 0x61, 0x14), 0);
        break;
    case 1:
        out.setTextColor(Color::getColorFromRGB(0xFF, 0x61, 0x14), 0);
        break;
    case 2:
        inOut.setTextColor(Color::getColorFromRGB(0xFF, 0x61, 0x14), 0);
        break;
    default:
        break;
    }
