...
void GraphView::setupScreen()
{
    ...
    {
        graphGridLines[i].setColor(Color::getColorFromRGB(0xE1, 0xE4, 0xE6));
        ...
        graphYValues[i].setXY(graphGridLines[i].getX() - graphYValues[i].getWidth() - 6, graphGridLines[i].getY() - (graphYValues[i].getTypedText().getFont()->getBaseline() / 2) - 2);
        graphArea.add(graphYValues[i]);
    }

    primaryGraph.setXY(graphXOffset, graphYOffset);
    primaryGraph.setup(graphWidth, graphHeight, Color::getColorFromRGB(0x24, 0x73, 0xAC), graphBackground.getColor());
    ...
    secondaryGraph.setup(graphWidth, graphHeight, Color::getColorFromRGB(0x27, 0x92, 0x34), graphBackground.getColor());
    ...
    {
        Color::getColorFromRGB(0x13, 0x89, 0xCC),   // Blue
        Color::getColorFromRGB(0x18, 0xB6, 0x84),   // Green
        Color::getColorFromRGB(0xFF, 0x78, 0x00),   // Orange
        Color::getColorFromRGB(0xD9, 0x0C, 0x33),   // Red
        Color::getColorFromRGB(0xFF, 0xBA, 0x00),   // Yellow
        Color::getColorFromRGB(0xA8, 0x00, 0xFF)    // Purple
    };
