    ...
    onSelectedElementChanged(this, &DatePicker::selectedElementChangedHandler)
{
    ...
    colortype normalTextColor = Color::getColorFromRGB(0x31, 0x31, 0x31);
    colortype selectedTextColor = Color::getColorFromRGB(0x00, 0x8A, 0xFF);
    colortype selectedBackgroundColor = Color::getColorFromRGB(0xF5, 0xF5, 0xF5);
