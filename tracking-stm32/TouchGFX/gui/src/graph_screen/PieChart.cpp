...
void PieChart::setPainter(int index, AbstractPainterABGR2222& painter)
#elif defined(LCD8BPP_RGBA2222)
void PieChart::setPainter(int index, AbstractPainterRGBA2222& painter)
#elif defined(LCD8BPP_BGRA2222)
void PieChart::setPainter(int index, AbstractPainterBGRA2222& painter)
#elif defined(LCD8BPP_ARGB2222) || USE_BPP==8
void PieChart::setPainter(int index, AbstractPainterARGB2222& painter)
#elif USE_BPP==4
