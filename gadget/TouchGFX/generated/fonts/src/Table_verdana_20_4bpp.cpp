...
KEEP extern const touchgfx::GlyphNode glyphs_verdana_20_4bpp[] FONT_TABLE_LOCATION_FLASH_ATTRIBUTE = {
    ...
    {   308, 0x0042,  12,  14,  14,   1,  14,   0,   0, 0x00 },
    {   392, 0x006E,  10,  11,  11,   1,  13,   0,   0, 0x00 },
    {   447, 0x006F,  11,  11,  11,   1,  12,   0,   0, 0x00 },
    {   513, 0x0074,   8,  14,  14,   0,   8,   0,   0, 0x00 },
    {   569, 0x0075,  10,  11,  11,   1,  13,   0,   0, 0x00 }
};
